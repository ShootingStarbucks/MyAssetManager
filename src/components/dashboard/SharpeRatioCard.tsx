        ...
        <CardContent className="pt-4">
          <div className="flex items-center justify-between mb-2">
            ...
            <button
              ...
              className="w-5 h-5 rounded-full border border-gray-300 text-gray-400 hover:border-gray-500 hover:text-gray-600 transition-colors flex items-center justify-center text-xs font-bold leading-none"
