...
const TOUR_STEPS: Step[] = [
  {
    ...
    content: '주식, 암호화폐, 예금 등 모든 자산을 한 화면에서 관리하세요.',
    placement: 'bottom',
    skipBeacon: true,
  },
  {
  ...
  },
  {
    ...
    title: '보유 자산 목록',
    content: '보유 자산의 현재가, 평가금액, 수익률을 한눈에 확인합니다.',
    placement: 'left',
  },
  {
    target: '#tour-add-asset-btn',
    title: '자산 추가',
    content: '주식, 암호화폐, 예금을 포트폴리오에 추가해 보세요.',
    placement: 'bottom',
  },
  {
    target: '#tour-settings-btn',
    title: '설정',
    content: 'AI API 키 등록 및 이 투어를 언제든 다시 볼 수 있습니다.',
    placement: 'bottom',
  },
];
